  ...
  export const _locale = {
    ...
    _data: {
      zh: {
        ...
        'welcome.title': 'Hesi',
        'welcome.subtitle': '浏览器中的通用终端中枢<br>让多个 AI 合在一起思考的地方<br>运行任何 CLI，连接任何 Agent，控制任何浏览器',
      ...
      en: {
        ...
        'welcome.title': 'Hesi',
        'welcome.subtitle': 'A Universal Terminal Hub Inside Your Browser<br>Where Multiple AI Agents Think Together<br>Run any CLI, connect any Agent, control any browser',
        'footer.title': 'Hesi v1.0.0',
