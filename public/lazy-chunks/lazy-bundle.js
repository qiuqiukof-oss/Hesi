import{a as A,b as ks,c as jt}from"./chunk-O2CIP7ES.js";import"./chunk-LZBE54RV.js";import{a as v}from"./chunk-SMZQELTL.js";var Qi=window.QCLI=window.QCLI||{},et=document.getElementById("terminal-search-bar"),Me=document.getElementById("terminal-search-input"),Ts=document.getElementById("terminal-search-results"),Vi=document.getElementById("terminal-search-prev"),Wi=document.getElementById("terminal-search-next"),Gi=document.getElementById("terminal-search-close");function Wn(){return et&&!et.classList.contains("hidden")}function Ji(){Wn()?Dt():Gn()}function Gn(){et&&(et.classList.remove("hidden"),Me.value="",Ts.textContent="0/0",Me.focus())}function Dt(){if(!et)return;et.classList.add("hidden"),window.QCLI?.searchAddon&&window.QCLI.searchAddon.clearActiveSearch();let e=window.QCLI?.Tabs?.term;e&&e.focus()}function Ki(){let e=Me.value.trim(),t=window.QCLI?.searchAddon;if(!t||!e){Ts.textContent="";return}t.clearActiveSearch();let s=t.findNext(e,{incremental:!1});Ts.textContent=s?"\u{1F50D} 1+":"\u2717"}function Jn(){let e=Me.value.trim(),t=window.QCLI?.searchAddon;!t||!e||t.findNext(e,{incremental:!0})}function Kn(){let e=Me.value.trim(),t=window.QCLI?.searchAddon;!t||!e||t.findPrevious(e,{incremental:!0})}Me&&(Me.addEventListener("input",Ki),Me.addEventListener("keydown",function(e){e.key==="Enter"&&(e.preventDefault(),e.shiftKey?Kn():Jn()),e.key==="Escape"&&Dt()}));Wi?.addEventListener("click",Jn);Vi?.addEventListener("click",Kn);Gi?.addEventListener("click",Dt);var Yi={visible:Wn,toggle:Ji,show:Gn,hide:Dt};Qi.TerminalSearch=Yi;var tt="[Storage]";function Yn(e,t){return{get(s,n=null){try{let a=e().getItem(s);return a!==null?a:n}catch(a){return console.warn(tt,`${t}.get("${s}") failed:`,a?.message),n}},set(s,n){try{return e().setItem(s,String(n)),!0}catch(a){return console.warn(tt,`${t}.set("${s}") failed:`,a?.message),!1}},remove(s){try{return e().removeItem(s),!0}catch(n){return console.warn(tt,`${t}.remove("${s}") failed:`,n?.message),!1}},getJSON(s,n=null){try{let a=e().getItem(s);return a!==null?JSON.parse(a):n}catch(a){return console.warn(tt,`${t}.getJSON("${s}") failed:`,a?.message),n}},setJSON(s,n){try{return e().setItem(s,JSON.stringify(n)),!0}catch(a){return console.warn(tt,`${t}.setJSON("${s}") failed:`,a?.message),!1}},keys(s=""){try{let n=e(),a=[];for(let o=0;o<n.length;o++){let i=n.key(o);i&&(!s||i.startsWith(s))&&a.push(i)}return a}catch(n){return console.warn(tt,`${t}.keys("${s}") failed:`,n?.message),[]}}}}var M=Yn(()=>localStorage,"local"),Ft=Yn(()=>sessionStorage,"session");if(typeof window<"u"){let e=window.QCLI=window.QCLI||{};e.safeStorage=M,e.safeSession=Ft}var q=window.QCLI=window.QCLI||{},I={collapsed:!1,activeTab:"dashboard",width:300},ge={};function Xi(e,t){return ge[e]||(ge[e]=[]),ge[e].push(t),function(){let n=ge[e].indexOf(t);n!==-1&&ge[e].splice(n,1)}}function Zi(e,t){if(!ge[e])return;if(!t){delete ge[e];return}let s=ge[e].indexOf(t);s!==-1&&ge[e].splice(s,1)}function eo(e){let t=ge[e];if(!t)return;let s=Array.prototype.slice.call(arguments,1);for(let n=0;n<t.length;n++)try{t[n].apply(null,s)}catch(a){console.warn("[RightPanel] Event handler error:",a)}}var K,le,ee,Ae,gt,Qt=!1,st=null,Es=200,Ls=800;var ea="qcli-right-panel-collapsed",ta="qcli-right-panel-width",sa="qcli-right-panel-tab",Xn="2";function to(){let e=(location.hash||"").replace(/^#/,"").trim();if(!e)return;let t=q.UIRegistry;!t||!t.getTabs||!t.getTabs().find(function(n){return n.id===e})||(I.activeTab=e,I.collapsed&&I.open())}function Ss(){K=document.getElementById("right-panel"),K&&(le=document.getElementById("right-panel-toggle"),ee=document.getElementById("right-panel-tabs"),Ae=document.getElementById("right-panel-content"),gt=document.getElementById("right-panel-resize-handle"),so(),to(),le&&le.addEventListener("click",Is),gt&&gt.addEventListener("mousedown",fo),co(),q.UIRegistry&&(q.UIRegistry.onTabRegistered=function(e){lo();let t=(location.hash||"").replace(/^#/,"").trim();e&&e.id===t&&(I.collapsed&&I.open(),ve(t,!0)),console.log("[RightPanel] Late-registered plugin tab:",e.id)}),window.addEventListener("hashchange",function(){let e=(location.hash||"").replace(/^#/,"").trim();if(!e)return;let t=q.UIRegistry;!t||!t.getTabs||!t.getTabs().find(function(n){return n.id===e})||(I.collapsed&&I.open(),I.activeTab!==e&&ve(e,!0))}),vt(),q.RightPanel=I,I.init=Ss,I.toggle=Is,I.switchTab=ve,I.open=io,I.close=oo,I.on=Xi,I.off=Zi,I.showTabSearch=_s,I.toggleMoreDropdown=na,I.createCollapsibleSection=uo,I.renderAllTabs=vt,console.log("[RightPanel] Initialized v2 \u2014 horizontal tab bar"))}function so(){M.get(ea)==="1"&&(I.collapsed=!0,K.classList.add("collapsed"),le&&(le.title="\u5C55\u5F00\u53F3\u4FA7\u680F"));let t=M.get(ta);if(t){let a=parseInt(t,10);a>=Es&&a<=Ls&&(I.width=a,oa(a))}let s=M.get(sa),n=M.get("qcli-tab-layout-version");s&&n===Xn&&(I.activeTab=s),M.set("qcli-tab-layout-version",Xn)}function Ms(){M.set(ea,I.collapsed?"1":"0")}function no(e){M.set(ta,String(e))}function ao(e){M.set(sa,e)}function Is(){K&&(I.collapsed=!I.collapsed,K.classList.toggle("collapsed",I.collapsed),le&&(le.title=I.collapsed?"\u5C55\u5F00\u53F3\u4FA7\u680F":"\u6536\u8D77\u53F3\u4FA7\u680F"),Ms(),setTimeout(Vt,280))}function io(){K&&(K.classList.remove("hidden","collapsed"),I.collapsed=!1,le&&(le.title="\u6536\u8D77\u53F3\u4FA7\u680F"),Ms(),setTimeout(Vt,280))}function oo(){K&&(K.classList.add("collapsed"),I.collapsed=!0,le&&(le.title="\u5C55\u5F00\u53F3\u4FA7\u680F"),Ms(),setTimeout(Vt,280))}function ve(e,t){if(!Ae||!t&&I.activeTab===e)return;let s=I.activeTab;I.activeTab=e,ao(e),ro(e),Ae.querySelectorAll(".rp-panel").forEach(function(r){r.classList.remove("active")});let a=document.getElementById("rp-"+e);if(a&&(a.classList.add("active"),!q.UIRegistry?.isTabRendered?.(e))){let r=q.UIRegistry?.getTabs().find(function(c){return c.id===e});if(r&&r.render)try{r.render(a),q.UIRegistry?.markTabRendered?.(e)}catch(c){console.error("[RightPanel] Plugin tab render error:",e,c)}}a&&(a.style.animation="none",a.offsetWidth,a.style.animation="");let o=K.querySelector(".right-panel-header-icon");if(o){let c=q.UIRegistry?.getTabs().find(function(l){return l.id===e});o.textContent=c?c.icon:"\u{1F4CA}"}let i=K.querySelector(".right-panel-title");if(i){let c=q.UIRegistry?.getTabs().find(function(l){return l.id===e});i.textContent=c?c.label:"\u5DE5\u4F5C\u53F0"}requestAnimationFrame(As),eo("tab:switch",e,s)}function ro(e){if(!ee)return;ee.querySelectorAll(".right-tab").forEach(function(n){n.classList.toggle("active",n.dataset.panel===e)});let s=document.getElementById("rp-tab-more-dropdown");s&&s.querySelectorAll(".rp-tab-more-item").forEach(function(n){n.classList.toggle("active",n.dataset.tabId===e)})}function co(){let e=document.getElementById("right-panel-tabs");e&&e.parentNode&&e.parentNode.removeChild(e);let t=document.createElement("div");t.className="right-panel-tab-bar",t.id="right-panel-tab-bar";let s=document.createElement("nav");s.className="right-panel-tabs",s.id="right-panel-tabs",t.appendChild(s);let n=document.createElement("div");n.className="right-panel-tab-actions",n.innerHTML=['<button class="rp-tab-action-btn" id="rp-tab-search-btn" title="\u641C\u7D22Tab (Ctrl+Shift+T)">\u{1F50D}</button>','<button class="rp-tab-action-btn" id="rp-tab-more-btn" title="\u66F4\u591ATab">\u2630</button>'].join(""),t.appendChild(n);let a=document.getElementById("right-panel-content");a&&a.parentNode&&a.parentNode.insertBefore(t,a),ee=s,s.addEventListener("click",function(o){let i=o.target.closest(".right-tab");i&&i.dataset.panel&&(ve(i.dataset.panel),I.collapsed&&Is())}),s.addEventListener("scroll",As),document.getElementById("rp-tab-search-btn").addEventListener("click",function(o){o.stopPropagation(),Ut(),_s()}),document.getElementById("rp-tab-more-btn").addEventListener("click",function(o){o.stopPropagation(),bt(),na()}),document.addEventListener("click",function(o){!o.target.closest(".rp-tab-more-dropdown")&&!o.target.closest("#rp-tab-more-btn")&&Ut(),!o.target.closest(".rp-tab-search-overlay")&&!o.target.closest("#rp-tab-search-btn")&&!o.target.closest("#rp-tab-search-input")&&bt()}),document.addEventListener("keydown",function(o){(o.ctrlKey||o.metaKey)&&o.shiftKey&&o.key==="T"&&(o.preventDefault(),Ut(),_s())})}var Cs=!1;function lo(){Cs||(Cs=!0,Promise.resolve().then(function(){Cs=!1,vt()}))}function vt(){if(!ee)return;ee.innerHTML="";let e=q.UIRegistry;if(!e)return;e.restoreHiddenPrefs();let t=e.getTabsByCategory(),s=!0;for(let n=0;n<t.length;n++){let a=t[n];if(a.tabs.length!==0){if(!s){let o=document.createElement("div");o.className="right-tab-category-gap",ee.appendChild(o)}s=!1;for(let o=0;o<a.tabs.length;o++){let i=a.tabs[o],r=mo(i);ee.appendChild(r);let c="rp-"+i.id;!document.getElementById(c)&&Ae&&Ae.appendChild(ho(i))}}}requestAnimationFrame(function(){let n=I.activeTab,a=q.UIRegistry;if(a&&a.isTabHidden(n)){let o=(a.getTabs()||[])[0];o&&(n=o.id)}ve(n,!0),As()})}function As(){if(!ee)return;let e=document.getElementById("right-panel-tab-bar");e&&(e.classList.toggle("can-scroll-left",ee.scrollLeft>2),e.classList.toggle("can-scroll-right",ee.scrollLeft<ee.scrollWidth-ee.clientWidth-2))}function _s(){Ut();let e=document.getElementById("rp-tab-search-overlay");if(e){e.remove();return}let t=document.createElement("div");t.className="rp-tab-search-overlay",t.id="rp-tab-search-overlay",t.innerHTML=['<input type="text" class="rp-tab-search-input" id="rp-tab-search-input" placeholder="\u{1F50D} \u641C\u7D22Tab\u540D\u79F0..." autofocus />','<div class="rp-tab-search-results" id="rp-tab-search-results"></div>'].join("");let s=document.getElementById("right-panel-tab-bar");s&&s.appendChild(t);let n=document.getElementById("rp-tab-search-input");n&&(setTimeout(function(){n.focus()},50),n.addEventListener("input",function(){Zn(this.value)}),n.addEventListener("keydown",function(a){if(a.key==="Escape"){bt();return}if(a.key==="Enter"){let o=t.querySelector(".rp-tab-search-item.highlighted");o&&o.dataset.tabId&&(ve(o.dataset.tabId),bt());return}if(a.key==="ArrowDown"||a.key==="ArrowUp"){a.preventDefault();let o=t.querySelectorAll(".rp-tab-search-item"),i=-1;o.forEach(function(r,c){r.classList.contains("highlighted")&&(i=c)}),i=a.key==="ArrowDown"?Math.min(i+1,o.length-1):Math.max(i-1,0),o.forEach(function(r){r.classList.remove("highlighted")}),o[i]&&(o[i].classList.add("highlighted"),o[i].scrollIntoView({block:"nearest"}))}})),Zn("")}function bt(){let e=document.getElementById("rp-tab-search-overlay");e&&e.remove()}function Zn(e){let t=document.getElementById("rp-tab-search-results");if(!t)return;let s=(e||"").toLowerCase().trim(),n=q.UIRegistry;if(!n){t.innerHTML='<div class="rp-tab-search-empty">UIRegistry \u672A\u5C31\u7EEA</div>';return}let a=n.getTabs(),o=s?a.filter(function(i){return i.label.toLowerCase().includes(s)||i.id.toLowerCase().includes(s)}):a.slice(0,20);if(o.length===0){t.innerHTML='<div class="rp-tab-search-empty">\u672A\u627E\u5230\u5339\u914D\u7684Tab</div>';return}t.innerHTML=o.map(function(i,r){let c=q.UIRegistry&&q.UIRegistry.getCategoryInfo?q.UIRegistry.getCategoryInfo(i.category):{label:"\u5176\u4ED6"};return'<div class="rp-tab-search-item'+(r===0?" highlighted":"")+'" data-tab-id="'+i.id+'"><span class="rtsi-icon">'+i.icon+"</span><span>"+i.label+'</span><span class="rtsi-category">'+c.label+"</span></div>"}).join(""),t.querySelectorAll(".rp-tab-search-item").forEach(function(i){i.addEventListener("click",function(){ve(this.dataset.tabId),bt()})})}function na(){let e=document.getElementById("rp-tab-more-dropdown");if(e){e.remove();return}let t=document.createElement("div");t.className="rp-tab-more-dropdown",t.id="rp-tab-more-dropdown";let s=q.UIRegistry;if(!s)return;let n=s.getTabsByCategory(),a="";for(let r=0;r<n.length;r++){let c=n[r];if(c.tabs.length!==0){a+='<div class="rp-tab-more-category">'+c.icon+" "+c.label+"</div>";for(let l=0;l<c.tabs.length;l++){let d=c.tabs[l],p=d.id===I.activeTab;a+='<div class="rp-tab-more-item'+(p?" active":"")+'" data-tab-id="'+d.id+'"><span class="rtmi-icon">'+d.icon+"</span><span>"+d.label+'</span><button class="rtmi-hide" title="\u9690\u85CF\u6B64Tab">\u2715</button></div>'}}}a+='<div style="border-top:1px solid var(--border-subtle);margin-top:4px;padding-top:4px;"><div class="rp-tab-more-item" data-action="tab-manager"><span class="rtmi-icon">\u2699\uFE0F</span><span>\u7BA1\u7406Tab...</span></div></div>',t.innerHTML=a;let o=document.getElementById("rp-tab-more-btn");o&&(o.parentElement.style.position="relative",o.parentElement.appendChild(t)),t.querySelectorAll(".rp-tab-more-item[data-tab-id]").forEach(function(r){r.addEventListener("click",function(c){if(c.target.closest(".rtmi-hide")){let l=this.dataset.tabId;if(s&&s.setTabHidden(l,!0),I.activeTab===l){let d=(s.getTabs()||[])[0];d&&ve(d.id)}vt(),t.remove();return}ve(this.dataset.tabId),t.remove()})});let i=t.querySelector('[data-action="tab-manager"]');i&&i.addEventListener("click",function(){t.remove(),po()})}function Ut(){let e=document.getElementById("rp-tab-more-dropdown");e&&e.remove()}function po(){let e=document.getElementById("rp-tab-manager");if(e){e.remove();return}let t=document.createElement("div");t.id="rp-tab-manager",t.className="rp-tab-manager",t.style.cssText="position:absolute;top:0;left:0;right:0;bottom:0;z-index:30;background:var(--bg-elevated);overflow-y:auto;";let s=q.UIRegistry,n=s?s.getAllTabs():[],a='<div style="display:flex;align-items:center;gap:8px;margin-bottom:12px;padding:12px 14px 0;"><h3 style="flex:1;margin:0;font-size:14px;">\u2699\uFE0F Tab \u7BA1\u7406</h3><button id="rp-tm-close" style="background:none;border:none;color:var(--text-tertiary);cursor:pointer;font-size:16px;padding:4px;">\u2715</button></div><div style="font-size:11px;color:var(--text-tertiary);margin-bottom:12px;padding:0 14px;">\u663E\u793A/\u9690\u85CF\u53F3\u4FA7\u680F\u4E2D\u7684Tab\uFF08\u9690\u85CF\u7684Tab\u4ECD\u53EF\u901A\u8FC7\u641C\u7D22\u8BBF\u95EE\uFF09</div>',o={};for(let r=0;r<n.length;r++){let c=n[r],l=c.category||"other";if(!o[l]){let d=q.UIRegistry&&q.UIRegistry.getCategoryInfo?q.UIRegistry.getCategoryInfo(l):{label:"\u5176\u4ED6",icon:"\u{1F4E6}"};o[l]={label:d.label,icon:d.icon,tabs:[]}}o[l].tabs.push(c)}let i=Object.keys(o);for(let r=0;r<i.length;r++){let c=o[i[r]];a+='<div style="font-size:11px;font-weight:600;color:var(--text-tertiary);padding:6px 14px 2px;">'+c.icon+" "+c.label+"</div>";for(let l=0;l<c.tabs.length;l++){let d=c.tabs[l],p=d.hidden;a+='<div class="rp-tm-item" style="padding:4px 14px;"><button class="rp-tm-toggle '+(p?"off":"on")+'" data-tab-id="'+d.id+'"></button><span>'+d.icon+" "+d.label+"</span></div>"}}t.innerHTML=a,Ae&&(Ae.style.position="relative",Ae.appendChild(t)),document.getElementById("rp-tm-close").addEventListener("click",function(){t.remove()}),t.querySelectorAll(".rp-tm-toggle").forEach(function(r){r.addEventListener("click",function(){let c=this.dataset.tabId,l=this.classList.contains("off");if(s&&(s.setTabHidden(c,!l),this.className="rp-tm-toggle "+(l?"on":"off")),vt(),!l&&I.activeTab===c){let d=s?s.getTabs()[0]:null;d&&ve(d.id)}})})}function uo(e){return['<div class="rp-collapsible'+(e.defaultOpen!==!1?" open":"")+'">','<div class="rp-collapsible-header">','<span class="rpc-icon">'+(e.icon||"\u{1F4CB}")+"</span>","<span>"+(e.title||"")+"</span>",'<span class="rpc-arrow">\u25B8</span>',"</div>",'<div class="rp-collapsible-body">','<div class="rp-collapsible-body-inner">',e.content||"","</div></div></div>"].join("")}function fo(e){e.preventDefault(),Qt=!0,K.classList.add("dragging"),gt.classList.add("active"),document.body.style.cursor="col-resize",document.body.style.userSelect="none",document.addEventListener("mousemove",aa),document.addEventListener("mouseup",ia)}function aa(e){Qt&&(st||(st=requestAnimationFrame(function(){st=null;let s=window.innerWidth-e.clientX;s<Es&&(s=Es),s>Ls&&(s=Ls),I.width=s,oa(s)})))}function ia(){Qt&&(Qt=!1,st&&(cancelAnimationFrame(st),st=null),K.classList.remove("dragging"),gt.classList.remove("active"),document.body.style.cursor="",document.body.style.userSelect="",no(I.width),requestAnimationFrame(Vt),document.removeEventListener("mousemove",aa),document.removeEventListener("mouseup",ia))}function oa(e){document.documentElement.style.setProperty("--right-panel-width",e+"px"),K.style.width="",K.style.minWidth=""}function mo(e){let t=document.createElement("button");return t.className="right-tab"+(e.id===I.activeTab?" active":""),t.dataset.panel=e.id,t.title=e.label,t.innerHTML='<span class="right-tab-icon">'+e.icon+'</span><span class="right-tab-label">'+e.label+"</span>",t}function ho(e){let t=document.createElement("div");return t.className="rp-panel",t.id="rp-"+e.id,t}function Vt(){try{let e=window.QCLI?.Tabs?.fitAddon,t=window.QCLI?.state;if(e&&(e.fit(),t&&t.launched)){let s=e.proposeDimensions();if(s){let n=window.QCLI?.wsSend;n&&n({type:"resize",cols:s.cols,rows:s.rows,tabId:window.QCLI?.Tabs?.activeTabId})}}}catch(e){console.debug("[RightPanel] terminal fit error:",e?.message)}}q.RightPanel=I;document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ss):Ss();var $s=window.QCLI||{},ra=!1;function go(e){if(!e||e<1e3)return"0s";let t=Math.floor(e/1e3);if(t<60)return t+"s";let s=Math.floor(t/60);return s<60?s+"m"+t%60+"s":Math.floor(s/60)+"h"+s%60+"m"}function ca(){if(ra)return;ra=!0;let e=async()=>{let t=document.getElementById("mcp-status-badge");if(t)try{let s=await fetch("/api/mcp/status");if(!s.ok)throw new Error("HTTP "+s.status);let n=await s.json();t.classList.remove("is-running","is-enabled","is-off","is-error"),n.running?(t.classList.add("is-running"),t.textContent=`\u8FD0\u884C\u4E2D \xB7 ${go(n.uptimeMs)} \xB7 \u91CD\u542F${n.restartCount}`,t.title=`PID ${n.pid} \xB7 \u6307\u6807 ${n.metricCount} \xB7 \u51FA ${n.stdoutBytes}B / \u9519 ${n.stderrBytes}B`):n.enabled?(t.classList.add("is-enabled"),t.textContent="\u5DF2\u542F\u7528 \xB7 \u672A\u8FD0\u884C",t.title="MCP \u7BA1\u7406\u5668\u5DF2\u521B\u5EFA\u4F46\u5B50\u8FDB\u7A0B\u672A\u8FD0\u884C"):(t.classList.add("is-off"),t.textContent="\u672A\u542F\u7528",t.title=n.message||"\u4F7F\u7528 --with-mcp \u542F\u52A8\u4EE5\u542F\u7528 MCP")}catch(s){let n=document.getElementById("mcp-status-badge");n&&(n.classList.remove("is-running","is-enabled","is-off"),n.classList.add("is-error"),n.textContent="\u72B6\u6001\u83B7\u53D6\u5931\u8D25",n.title=String(s?.message||s))}};e(),setInterval(e,5e3)}var nt={events:[],cacheHits:0,cacheMisses:0,tokenSaved:0,callsByTool:{},_timeline:[],_pulse:!1,push(e){let t=Date.now();this._timeline.push({t,ev:e.ev||"unknown"});let s=t-6e4;for(;this._timeline.length>0&&this._timeline[0].t<s;)this._timeline.shift();this.events.push(e),this.events.length>200&&this.events.shift(),e.cached===!0?this.cacheHits++:(e.ev==="tool_call"||e.ev==="resource_read")&&this.cacheMisses++,e.tokenSaved&&(this.tokenSaved+=e.tokenSaved),e.tool&&(this.callsByTool[e.tool]=(this.callsByTool[e.tool]||0)+1),this._pulse=!0,setTimeout(()=>{this._pulse=!1},600),document.getElementById("rp-dashboard")?.classList.contains("active")&&requestAnimationFrame(()=>{bo(),yo()})},get hitRate(){let e=this.cacheHits+this.cacheMisses;return e===0?0:this.cacheHits/e},get eventsPerSecond(){return Math.min(this._timeline.length,60)===0?0:(this._timeline.length/60).toFixed(1)},reset(){this.events=[],this.cacheHits=0,this.cacheMisses=0,this.tokenSaved=0,this.callsByTool={},this._timeline=[],this._pulse=!1}},vo={tool_call:"\u5DE5\u5177\u8C03\u7528",resource_read:"\u8D44\u6E90\u8BFB\u53D6",cache_summary:"\u7F13\u5B58\u6C47\u603B"};function Wt(){let e=nt,t=e.events.length;A("dash-mcp-count",t),A("dash-mcp-hitrate",(e.hitRate*100).toFixed(1)+"%"),A("dash-mcp-hits",e.cacheHits),A("dash-mcp-misses",e.cacheMisses);let s=e.tokenSaved,n=s===0?"0 B":s<1024?s+" B":s<1048576?(s/1024).toFixed(1)+" KB":(s/1048576).toFixed(1)+" MB";A("dash-mcp-saved",n);let a=document.getElementById("mcp-pulse-dot");a&&(a.classList.toggle("active",e._pulse),e._pulse&&a.offsetWidth),A("mcp-rate-badge",e.eventsPerSecond+" eps");let o=document.getElementById("dash-mcp-empty");o&&(o.style.display=t===0?"":"none");let i=document.getElementById("dash-mcp-log");if(!i||t===0)return;let r=t+"|"+(e.events[t-1]?.ev||"");if(i.dataset.lastSerial===r)return;i.dataset.lastSerial=r;let c=e.events.slice(-15).reverse();i.innerHTML=c.map((l,d)=>{let p=l.cached?"\u2705":l.ev==="tool_call"?"\u{1F527}":l.ev==="resource_read"?"\u{1F4C4}":"\u26A1",u=l.tool||l.resource||vo[l.ev]||"\u672A\u77E5\u4E8B\u4EF6",f=l.tokens?` (${l.tokens} tok)`:"",m=l.tokenSaved?` <span class="mcp-saved">-${l.tokenSaved}tok</span>`:"";return`<div class="mcp-log-entry${d===0&&t>0?" mcp-entry-new":""}">${p} <span class="mcp-entry-name">${v(u)}</span>${f}${m}</div>`}).join("")}function bo(){let e=document.getElementById("mcp-sparkline");if(!e)return;e.clientWidth>0&&e.clientWidth!==e.width&&(e.width=e.clientWidth),e.clientHeight>0&&e.clientHeight!==e.height&&(e.height=e.clientHeight);let t=e.getContext("2d"),s=e.width,n=e.height;t.clearRect(0,0,s,n);let a=nt._timeline;if(a.length<2){t.fillStyle=getComputedStyle(document.documentElement).getPropertyValue("--text-tertiary").trim()||"#71717a",t.font="9px monospace",t.textAlign="center",t.fillText("\u7B49\u5F85\u4E8B\u4EF6...",s/2,n/2+3);return}let o=Date.now(),i=new Array(60).fill(0),r=o-6e4;for(let h of a){if(h.t<r)continue;let y=Math.min(59,Math.floor((h.t-r)/1e3));i[y]++}let c=Math.max(1,...i),l=getComputedStyle(document.documentElement).getPropertyValue("--accent").trim()||"#6366f1",d=s/60;t.beginPath(),t.moveTo(0,n);for(let h=0;h<60;h++){let y=h*d+d/2,b=i[h]/c*(n-4),g=n-2-b;t.lineTo(y,g)}t.lineTo(s,n),t.closePath();let p=$s.ChartCore&&$s.ChartCore.parseHexToRgba?$s.ChartCore.parseHexToRgba:function(){return null},u=t.createLinearGradient(0,0,0,n),f=p(l,.25),m=p(l,.02);f&&m?(u.addColorStop(0,f),u.addColorStop(1,m)):(u.addColorStop(0,"rgba(99,102,241,0.25)"),u.addColorStop(1,"rgba(99,102,241,0.02)")),t.fillStyle=u,t.fill(),t.beginPath(),t.strokeStyle=l,t.lineWidth=1.2;for(let h=0;h<60;h++){let y=h*d+d/2,b=i[h]/c*(n-4),g=n-2-b;h===0?t.moveTo(y,g):t.lineTo(y,g)}if(t.stroke(),i[59]>0){let h=59*d+d/2,y=i[59]/c*(n-4),b=n-2-y;t.beginPath(),t.arc(h,b,2.5,0,Math.PI*2),t.fillStyle=l,t.fill()}}function yo(){let e=document.getElementById("mcp-tool-bars");if(!e)return;let t=document.getElementById("mcp-tools-empty"),s=nt.callsByTool,n=Object.entries(s);if(n.length===0){t&&(t.style.display="");return}t&&(t.style.display="none");let a=n.reduce((r,[,c])=>r+c,0),o=n.sort((r,c)=>c[1]-r[1]).slice(0,6),i=o[0][1];e.innerHTML=o.map(([r,c])=>{let l=Math.round(c/a*100),d=c/i*100;return`<div class="mcp-tool-bar-row">
    ...
    `).join("")}let n=document.getElementById("dash-project-keyfiles");n&&e.keyFiles&&e.keyFiles.length>0?n.innerHTML='<div class="dash-project-section-label">\u{1F4C1} \u68C0\u6D4B\u5230\u914D\u7F6E\u6587\u4EF6</div>'+e.keyFiles.map(a=>`
      ...
      ${ze}
    </div>`}).join("");let l=document.getElementById("dash-proc-toggle");if(l&&(l.textContent=xt?"\u{1F4CA} \u6536\u8D77\u8D8B\u52BF":"\u{1F4CA} \u5C55\u5F00\u8D8B\u52BF"),xt&&Co(),a&&a.processes){let d=new Map;for(let p=0;p<a.processes.length;p++){let u=a.processes[p];d.set(u.tabId,u)}yt.checkProcessThresholds(d)}}var Eo={_modal:null,open(e,t){this._ensureEl(),this._modal.classList.add("active"),this._modal.querySelector(".dash-modal-title").textContent=`${t} \u8FDB\u7A0B\u8BE6\u60C5`,this._modal.querySelector(".dash-modal-body").innerHTML='<div class="dash-empty">\u52A0\u8F7D\u4E2D...</div>',this._fetchDetail(e)},close(){this._modal&&this._modal.classList.remove("active")},_ensureEl(){this._modal||(this._modal=document.createElement("div"),this._modal.className="dash-modal-overlay",this._modal.innerHTML=`
    ...
    `;let n=document.getElementById("dash-kill-btn");n&&t.pid&&n.addEventListener("click",async()=>{if(confirm(`\u786E\u5B9A\u7EC8\u6B62\u8FDB\u7A0B ${t.pid} (${t.name||""})\uFF1F`)){n.disabled=!0,n.textContent="\u7EC8\u6B62\u4E2D...";try{let o=await(await fetch("/api/system/kill-process",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({pid:t.pid})})).json();o.success?(n.textContent="\u2705 \u5DF2\u7EC8\u6B62",setTimeout(()=>this.close(),1e3)):(n.textContent="\u274C \u7EC8\u6B62\u5931\u8D25: "+(o.error||"\u672A\u77E5\u9519\u8BEF"),n.disabled=!1)}catch{n.textContent="\u274C \u8BF7\u6C42\u5931\u8D25",n.disabled=!1}}})}};function Lo(e,t){Eo.open(e,t)}document.addEventListener("click",e=>{let t=e.target.closest(".dash-process-item");if(t&&!e.target.closest(".dash-process-pid")&&!e.target.closest(".dash-chip-btn")){let s=t.dataset.tabId;if(s){let a=((window.QCLI||{}).Tabs?.tabs||[]).find(o=>o.tabId===s);Lo(s,a?.name||a?.cliId||"Terminal")}}});var z=window.QCLI=window.QCLI||{},H={_startTime:Date.now(),_refreshTimer:null,_REFRESH_MS:1e4,_pollTimer:null,_POLL_MS:3e3,_initialized:!1,_prevValues:{clis:0,agent:0,directory:0,tool:0,tabs:0,favorites:0},_clockTimer:null};H.mcpPush=e=>nt.push(e);z._dashboardMonitor=C;function Us(){if(H._initialized)return;H._initialized=!0,ca();let e=document.getElementById("right-panel-tabs");e&&e.addEventListener("click",s=>{let n=s.target.closest(".right-tab");n&&n.dataset.panel==="dashboard"&&Tt()}),z.RightPanel&&z.RightPanel.on&&z.RightPanel.on("tab:switch",function(s){s==="dashboard"&&(da(),Tt())}),ga(),_o(),Ao(),Ps(),C.startPing();let t=z.onWSMessage;z.onWSMessage=function(s){C.onWSMessage(s),t&&t(s)},z.RightPanel&&z.RightPanel.on&&z.RightPanel.on("tab:switch",function(s){let a={dashboard:"\u4EEA\u8868\u76D8",media:"\u591A\u5A92\u4F53"}[s]||s;Do("tab","\u5207\u6362\u5230 "+a)}),So(),window.addEventListener("beforeunload",Io),console.log("[Dashboard] Initialized")}function So(){typeof z.UIRegistry?.registerTab=="function"&&z.UIRegistry.registerTab("dashboard",{icon:"\u{1F4CA}",label:"\u4EEA\u8868\u76D8",category:"monitor",order:0,render:e=>{e&&(e.style.display="")}})}function Io(){Mo(),$o(),C.stopPing(),H._clockTimer&&(clearInterval(H._clockTimer),H._clockTimer=null)}function _o(){H._refreshTimer||(H._refreshTimer=setInterval(()=>{if(!document.getElementById("right-panel-content"))return;let t=document.getElementById("rp-dashboard");if(!t||!t.classList.contains("active"))return;let s=document.getElementById("right-panel");s&&s.classList.contains("collapsed")||Tt()},H._REFRESH_MS))}function Mo(){H._refreshTimer&&(clearInterval(H._refreshTimer),H._refreshTimer=null)}function Ao(){H._pollTimer||(H._pollTimer=setInterval(()=>{try{Hs(),Ns()}catch{}},H._POLL_MS))}function $o(){H._pollTimer&&(clearInterval(H._pollTimer),H._pollTimer=null)}function Tt(){Ho(),No(),zo(),js(),Wt(),Ds(),jo(),va(),Hs(),Ns(),Oo(),(C.sys.rss>0||C.latency>0)&&yt.checkThresholds(C.sys.rss,C.sys.heap,C.latency)}function ga(){let e=document.getElementById("rp-dashboard");if(!e)return;qs(),e.innerHTML=`
...
`;rn({name:"",urlPattern:i?i.replace(/^(https?:\/\/[^/]+).*$/,"$1/*"):"*://*/*",description:"\u4ECE\u7EC8\u7AEF\u521B\u5EFA\u7684\u811A\u672C",code:r,tags:["terminal"]})}}),s.registerCommand("browser-scripts:open",{icon:"\u{1F4DC}",name:"\u6253\u5F00\u6D4F\u89C8\u5668\u811A\u672C\u7BA1\u7406",desc:"\u7BA1\u7406\u7528\u6237\u811A\u672C\uFF08\u65B0\u5EFA\u3001\u7F16\u8F91\u3001\u542F\u7528/\u7981\u7528\uFF09",category:"browser",execute:()=>{let a=t.RightPanel;a&&(a.collapsed&&a.open(),a.switchTab("browser-scripts"))}}),t.injectCSS("/css/browser-scripts.css")})();function Lt(){return window.QCLI||{}}var se=[],Y=!1,Et="",cn="all",N=null;async function es(e,t){try{return await(await fetch("/api/browser/network",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({action:e,filter:t})})).json()}catch(s){return{success:!1,error:s.message}}}function ts(){N&&N.panel&&N.panel._pollTimer&&(clearInterval(N.panel._pollTimer),N.panel._pollTimer=null)}async function mr(){let e=await es("start");if(e.success)Y=!0,ns(),N&&N.panel&&(ts(),N.panel._pollTimer=setInterval(Pa,2e3));else{let t=Lt().showToast;t&&t("\u274C \u542F\u52A8\u7F51\u7EDC\u76D1\u63A7\u5931\u8D25\uFF1A"+(e.error||"\u672A\u77E5\u9519\u8BEF")+"\uFF08\u8BF7\u5148\u8FDE\u63A5\u6D4F\u89C8\u5668 CDP\uFF09","error")}return e}async function ln(){Y=!1,ts(),await es("stop"),ns()}async function Pa(){if(!Y)return;let e=await es("get");e.success&&e.entries&&(se=e.entries,De(),ss(e.stats),typeof e.isActive=="boolean"&&e.isActive!==Y&&(Y=e.isActive,ns(),Y||ts()))}async function Ra(){let e=await es("get");e.success&&(se=e.entries||[],De(),ss(e.stats),Y=e.isActive||!1,Y&&N&&N.panel&&!N.panel._pollTimer&&(N.panel._pollTimer=setInterval(Pa,2e3)),ns())}async function hr(){se=[],De(),ss(null)}function De(){if(!N||!N.list)return;let e=se.filter(t=>!(Et&&!t.url.toLowerCase().includes(Et.toLowerCase())||cn!=="all"&&t.type!==cn));if(N.list.innerHTML="",e.length===0){N.list.innerHTML=`<div class="nm-empty">
  ...
  `}}function ns(){!N||!N.recordBtn||(N.recordBtn.innerHTML=Y?'<span class="nm-recording-dot"></span> \u505C\u6B62':"\u25B6 \u6355\u83B7",N.recordBtn.className="nm-btn"+(Y?" recording":""))}function gr(e,t){if(!e)return"";if(e.length<=t)return e;try{let s=new URL(e),n=s.pathname+s.search,a=s.hostname,o=a.length+8,i=t-o-3;if(i>10)return s.protocol+"//"+a+n.slice(0,i)+"..."}catch(s){console.warn("[NetworkMonitor] truncateUrl parse error:",s?.message)}return e.slice(0,t)+"..."}function vr(e){let t=[];return t.push(`URL: ${e.url}`),t.push(`Method: ${e.method}`),t.push(`Status: ${e.status} ${e.statusText||""}`),t.push(`Type: ${e.type}`),t.push(`Duration: ${e.duration||0}ms`),t.push(`Time: ${e.timestamp||""}`),e.requestHeaders&&Object.keys(e.requestHeaders).length>0&&t.push(`
Request Headers:
...
`)}function br(){if(se.length===0){let i=Lt().showToast;i&&i("\u6CA1\u6709\u6570\u636E\u53EF\u5BFC\u51FA","info");return}let e={log:{version:"1.2",creator:{name:"Hesi Network Monitor",version:"1.0"},entries:se.map(i=>yr(i))}},t=JSON.stringify(e,null,2),s=new Blob([t],{type:"application/har+json"}),n=URL.createObjectURL(s),a=document.createElement("a");a.href=n,a.download=`network-traffic-${Date.now()}.har`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(n);let o=Lt().showToast;o&&o(`\u{1F4E4} \u5DF2\u5BFC\u51FA ${se.length} \u6761\u8BF7\u6C42\u4E3A HAR \u6587\u4EF6`,"success")}function yr(e){let t=[];try{new URL(e.url).searchParams.forEach((l,d)=>{t.push({name:d,value:l})})}catch(c){console.warn("[NetworkMonitor] URL parse error in HAR entry:",c?.message)}let s=Ba(e.requestHeaders||{}),n=Ba(e.responseHeaders||{}),a=e.body?e.body.length:-1,o="application/octet-stream";for(let c of n)if(c.name.toLowerCase()==="content-type"){o=c.value;break}let i=e.timestamp||new Date().toISOString(),r=e.duration||0;return{startedDateTime:i,time:r,request:{method:e.method||"GET",url:e.url,httpVersion:"HTTP/1.1",headers:s,queryString:t,cookies:[],headersSize:-1,bodySize:e.body?e.body.length:-1,postData:(e.method==="POST"||e.method==="PUT"||e.method==="PATCH")&&e.body?{mimeType:o,text:e.body.slice(0,1e4),size:a}:void 0},response:{status:e.status||0,statusText:e.statusText||"",httpVersion:"HTTP/1.1",headers:n,cookies:[],content:{size:a,mimeType:o,text:e.body?e.body.slice(0,1e4):void 0},redirectURL:"",headersSize:-1,bodySize:a},cache:{},timings:{blocked:-1,dns:-1,connect:-1,send:0,wait:r,receive:0,ssl:-1},_resourceType:e.type||"xhr",_error:e.error||!1}}function Ba(e){return!e||typeof e!="object"?[]:Object.entries(e).filter(([t,s])=>s!=null).map(([t,s])=>({name:t,value:String(s)}))}function xr(){let e=document.createElement("input");e.type="file",e.accept=".har,application/json,application/har+json",e.addEventListener("change",async t=>{let s=t.target.files?.[0];if(s)try{let n=await s.text(),a=JSON.parse(n);if(!a.log||!a.log.entries)throw new Error("\u65E0\u6548\u7684 HAR \u6587\u4EF6\uFF1A\u7F3A\u5C11 log.entries");Y&&await ln();let o=a.log.entries.map(wr),i=Lt().showToast;se=o,De(),ss({total:se.length,errors:se.filter(r=>r.error).length,byMethod:{},byType:{},avgDuration:se.reduce((r,c)=>r+(c.duration||0),0)/Math.max(1,se.length)}),i&&i(`\u{1F4E5} \u5DF2\u5BFC\u5165 ${o.length} \u6761 HAR \u8BF7\u6C42\u8BB0\u5F55`,"success")}catch(n){let a=Lt().showToast;a&&a(`\u274C HAR \u5BFC\u5165\u5931\u8D25: ${n.message}`,"error")}}),e.click()}function wr(e){let t=e.request||{},s=e.response||{},n=s.content||{},a={};if(Array.isArray(t.headers))for(let i of t.headers)a[i.name]=i.value;let o={};if(Array.isArray(s.headers))for(let i of s.headers)o[i.name]=i.value;return{id:"har-"+Date.now()+"-"+Math.random().toString(36).slice(2,8),url:t.url||"",method:t.method||"GET",type:e._resourceType||"xhr",status:s.status||0,statusText:s.statusText||"",requestHeaders:a,responseHeaders:o,body:n.text||"",duration:e.time||e.timings?.wait||0,timestamp:e.startedDateTime||new Date().toISOString(),error:e._error||s.status>=400}}function kr(e){ts(),e.innerHTML=`
    <div class="nm-panel">
  ...
  `,N={panel:e,list:e.querySelector("#nm-list"),statsBar:e.querySelector("#nm-stats-bar"),recordBtn:e.querySelector("#nm-record-btn"),filterInput:e.querySelector("#nm-filter-input")},N.recordBtn.addEventListener("click",async()=>{Y?await ln():(se=[],De(),await mr())}),e.querySelector("#nm-clear-btn").addEventListener("click",async()=>{Y&&await ln(),await hr()}),e.querySelector("#nm-refresh-btn").addEventListener("click",Ra),e.querySelector("#nm-export-btn").addEventListener("click",br),e.querySelector("#nm-import-btn").addEventListener("click",xr),e.querySelectorAll(".nm-type-btn").forEach(t=>{t.addEventListener("click",()=>{e.querySelectorAll(".nm-type-btn").forEach(s=>s.classList.remove("active")),t.classList.add("active"),cn=t.dataset.type,De()})}),N.filterInput.addEventListener("input",t=>{Et=t.target.value,De()}),Ra()}(function e(){let t=window.QCLI||{},s=t.UIRegistry;if(!s){console.warn("[NetworkMonitor] UIRegistry not available, will retry"),setTimeout(e,500);return}s.registerTab("network-monitor",{category:"other",icon:"\u{1F310}",label:"\u7F51\u7EDC\u76D1\u63A7",order:40,render:a=>kr(a)})&&console.log('[NetworkMonitor] Panel registered as "network-monitor" tab'),s.registerCommand("network-monitor:open",{icon:"\u{1F310}",name:"\u6253\u5F00\u7F51\u7EDC\u76D1\u63A7",desc:"\u76D1\u63A7\u6D4F\u89C8\u5668\u7F51\u7EDC\u8BF7\u6C42",category:"browser",execute:()=>{let a=t.RightPanel;a&&(a.collapsed&&a.open(),a.switchTab("network-monitor"))}}),t.injectCSS("/css/network-monitor.css")})();function is(){return window.QCLI||{}}var as=[],Ha=0,pt=null;async function Tr(){try{let t=await(await fetch("/api/browser/farm/contexts")).json();return t.success&&(as=t.contexts||[],Ha=t.activeContext||0),t}catch{return{contexts:[]}}}async function Cr(e){try{return await(await fetch("/api/browser/farm/create",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({label:e})})).json()}catch(t){return{success:!1,error:t.message}}}async function Er(e){try{return await(await fetch("/api/browser/farm/switch",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({index:e})})).json()}catch(t){return{success:!1,error:t.message}}}async function Lr(e){try{return await(await fetch("/api/browser/farm/close",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({index:e})})).json()}catch(t){return{success:!1,error:t.message}}}function Sr(){if(!(!pt||!pt.list)){if(pt.list.innerHTML="",as.length===0){pt.list.innerHTML='<div class="bf-empty"><div class="bf-empty-icon">\u{1F33E}</div><p>\u6CA1\u6709\u6D3B\u8DC3\u7684\u6D4F\u89C8\u5668\u4F1A\u8BDD</p><p style="font-size:11px;color:var(--text-tertiary);margin-top:4px;">\u5148\u8FDE\u63A5\u6D4F\u89C8\u5668\uFF0C\u7136\u540E\u521B\u5EFA\u65B0\u4F1A\u8BDD</p></div>';return}for(let e=0;e<as.length;e++){let t=as[e],s=e===Ha,n=document.createElement("div");n.className="bf-session"+(s?" active":"");let a=document.createElement("div");a.className="bf-session-status"+(s?" online":""),n.appendChild(a);let o=document.createElement("div");o.className="bf-session-info";let i=document.createElement("div");i.className="bf-session-header",i.innerHTML=`<span class="bf-session-name">${v(t.label||"Session #"+e)}</span>
      <span class="bf-session-id">ctx-${e}</span>
      ${s?'<span class="bf-session-badge">\u5F53\u524D</span>':""}`,o.appendChild(i);let r=document.createElement("div");if(r.className="bf-session-meta",r.textContent=`${t.pages||0} \u4E2A\u9875\u9762 \xB7 ${t.createdAt?_r(t.createdAt):"\u521A\u521A"}`,o.appendChild(r),t.urls&&t.urls.length>0){let l=document.createElement("div");l.className="bf-session-urls",l.textContent=t.urls.slice(0,3).join(", ")+(t.urls.length>3?` +${t.urls.length-3}`:""),o.appendChild(l)}n.appendChild(o);let c=document.createElement("div");if(c.className="bf-session-actions",!s){let l=document.createElement("button");l.className="bf-action-btn",l.textContent="\u5207\u6362",l.title="\u5207\u6362\u5230\u8BE5\u4F1A\u8BDD",l.addEventListener("click",async d=>{if(d.stopPropagation(),(await Er(e)).success){await St();let u=is().showToast;u&&u(`\u5DF2\u5207\u6362\u5230\u4F1A\u8BDD #${e}`,"success")}}),c.appendChild(l)}if(e>0){let l=document.createElement("button");l.className="bf-action-btn danger",l.textContent="\u2715",l.title="\u5173\u95ED\u4F1A\u8BDD",l.addEventListener("click",async d=>{d.stopPropagation();let p=await Lr(e);if(p.success){await St();let u=is().showToast;u&&u(p.message,"info")}}),c.appendChild(l)}n.appendChild(c),pt.list.appendChild(n)}}}function St(){return Tr().then(()=>Sr())}function Ir(e){e.innerHTML=`
    <div class="bf-panel">
...
`),d=[];for(let p=0;p<l.length;p++)l[p].toLowerCase().includes(a)&&d.push({lineNum:p+1,text:l[p]});d.length>0&&(r.push({tab:c,matches:d}),i+=d.length)}if(n&&(n.textContent=i>0?`${i} \u6761`:""),r.length===0){t.innerHTML='<div class="gsr-empty">\u672A\u627E\u5230\u5339\u914D\u7ED3\u679C</div>',s&&(s.textContent=`\u641C\u7D22 "${e}" \u2014 \u5171 0 \u6761`,s.classList.add("visible"));return}s&&(s.textContent=`\u641C\u7D22 "${e}" \u2014 \u5728 ${r.length} \u4E2A\u7EC8\u7AEF\u4E2D\u627E\u5230 ${i} \u6761`,s.classList.add("visible")),t.innerHTML="";for(let c of r){let l=c.tab,d=document.createElement("div");d.className="gsr-tab-group";let p=document.createElement("div");p.className="gsr-tab-header",p.textContent=`${l.icon||"\u25B8"} ${l.name||l.cliId||"Terminal"}`;let u=document.createElement("span");u.textContent=` (${c.matches.length})`,p.appendChild(u),d.appendChild(p);let f=50,m=c.matches.slice(0,f);for(let h of m){let y=document.createElement("div");y.className="gsr-item",y.dataset.tabId=l.tabId;let b=document.createElement("span");b.className="gsr-item-line",b.textContent=h.lineNum,y.appendChild(b);let g=document.createElement("span");g.className="gsr-item-text";let x=h.text.toLowerCase().indexOf(a);if(x!==-1){let k=h.text.slice(0,x),P=h.text.slice(x,x+e.length),O=h.text.slice(x+e.length);g.innerHTML=v(k)+"<mark>"+v(P)+"</mark>"+v(O)}else g.textContent=h.text;y.appendChild(g),y.addEventListener("click",()=>{ut(),l.tabId&&fe().Tabs&&fe().Tabs.switch(l.tabId);let k=fe().Tabs?.term;k&&k.focus()}),d.appendChild(y)}if(c.matches.length>f){let h=document.createElement("div");h.className="gsr-empty",h.style.padding="8px var(--space-2)",h.style.fontSize="11px",h.textContent=`\u2026 \u8FD8\u6709 ${c.matches.length-f} \u6761\u7ED3\u679C`,d.appendChild(h)}t.appendChild(d)}}Promise.resolve().then(()=>{fe()._globalSearchPatched||(fe()._globalSearchPatched=!0,fe().openGlobalSearch=Va,fe().closeGlobalSearch=ut,fe().toggleGlobalSearch=Or,fe().renderGlobalSearchResults=Qa,document.addEventListener("keydown",e=>{let t=document.getElementById("global-search-panel");if(!(!t||t.classList.contains("hidden"))&&e.key==="Escape"){e.preventDefault(),ut();let s=fe().Tabs?.term;s&&s.focus()}}),document.getElementById("global-search-input")?.addEventListener("input",e=>{Qa(e.target.value)}),document.getElementById("global-search-close-btn")?.addEventListener("click",ut),document.getElementById("global-search-bg")?.addEventListener("click",ut))});var Be=window.QCLI||{},J={plugins:[],loading:!1,detail:null};(function(){let t="pm-panel-css";if(document.getElementById(t))return;let s=document.createElement("style");s.id=t,s.textContent=`
  ...
  `}async function Zr(e){rs=e,e.innerHTML=`
    <div class="rl-panel">
      <div class="rl-header">
  ...
  `;let t=e.querySelector(".rl-refresh-btn");t&&t.addEventListener("click",()=>{t.classList.add("spinning"),At().finally(()=>{setTimeout(()=>t.classList.remove("spinning"),300)})}),await At(),clearInterval(ft),ft=setInterval(At,Ja),fn&&fn();let s=Ya().RightPanel;s&&s.on&&(fn=s.on("tab:switch",n=>{n!=="rate-limit"?(clearInterval(ft),ft=null):ft||(ft=setInterval(At,Ja),At())}))}async function At(){if(!rs)return;let e=await Kr();if(!e)return;let t=rs.querySelector("#rl-limiters"),s=rs.querySelector("#rl-update-time");if(!t)return;let n=e.limiters||[];if(n.length===0){t.innerHTML='<div class="rl-empty">\u6682\u65E0\u9650\u6D41\u5668\u6570\u636E</div>';return}let a=null;if(un){a={};for(let i of n){let r=un.find(c=>c.name===i.name);r&&(a[i.name]={totalRequests:i.totalRequests-r.totalRequests,blocked:i.blocked-r.blocked})}}un=n;let o=[...n].sort((i,r)=>{let c=i.totalRequests>0?i.blocked/i.totalRequests:0;return(r.totalRequests>0?r.blocked/r.totalRequests:0)-c});t.innerHTML=o.map(i=>Xr(i,a?.[i.name])).join(""),s&&(s.textContent="\u66F4\u65B0: "+new Date(e.ts).toLocaleTimeString())}(function e(){let t=Ya().UIRegistry;if(!t){console.warn("[RateLimitPanel] UIRegistry not available, will retry"),setTimeout(e,200);return}t.registerTab("rate-limit",{category:"plugin",icon:"\u{1F6A6}",label:"\u9650\u6D41",order:31,render:function(n){Zr(n)}})&&console.log("[RateLimitPanel] Registered rate-limit tab in right panel")})();(function(){let t="rl-panel-css";if(document.getElementById(t))return;let s=document.createElement("style");s.id=t,s.textContent=`
    .rl-panel {
      padding: 12px;
      height: 100%;
      display: flex;
...
`,document.head.appendChild(e)}Z=document.createElement("div"),Z.id="voice-confirm-bar",Z.className="voice-confirm-bar hidden",Z.innerHTML=`
    ...
    </div>`,document.body.appendChild(Z),X=Z.querySelector("#vc-text"),Pe=Z.querySelector("#vc-target"),Z.querySelector("#vc-send").addEventListener("click",()=>ei()),Z.querySelector("#vc-cancel").addEventListener("click",()=>mn(!0)),Z.querySelector("#vc-rerecord").addEventListener("click",()=>vc()),Pe.addEventListener("click",()=>gc()),X.addEventListener("keydown",e=>{(e.ctrlKey||e.metaKey)&&e.key==="Enter"&&(e.preventDefault(),ei())})}}function gn(){if(Q.defaultTarget==="terminal")return"terminal";if(Q.defaultTarget==="chat")return"chat";let e=document.getElementById("chat-input");return e&&document.activeElement===e?"chat":window.QCLI?.state?.launched?"terminal":"chat"}function $t(e){return e==="terminal"?"\u53D1\u5230\u7EC8\u7AEF":"\u53D1\u5230\u804A\u5929"}function gc(){E.target=E.target==="terminal"?"chat":"terminal",E._targetPinned=!0,Pe&&(Pe.textContent=$t(E.target))}function ti(e){if(E.target==="chat"){if(window.QCLI?.ChatUI?.sendChatMessage){window.QCLI.ChatUI.sendChatMessage(e);return}let a=document.getElementById("chat-input");a&&(a.value=e,a.dispatchEvent(new KeyboardEvent("keydown",{key:"Enter",bubbles:!0})));return}let s=window.QCLI?.state?.launched,n=window.QCLI?.Tabs?.activeTabId;s&&n?window.QCLI?.wsSend?.({type:"input",data:e+`
`,tabId:n}):(window.QCLI?.showToast?.(s?"\u7EC8\u7AEF\u65E0\u6D3B\u52A8\u6807\u7B7E\u9875\uFF0C\u5DF2\u6539\u4E3A\u53D1\u9001\u5230\u804A\u5929":"\u7EC8\u7AEF\u672A\u8FD0\u884C\uFF0C\u5DF2\u6539\u4E3A\u53D1\u9001\u5230\u804A\u5929","info"),window.QCLI?.ChatUI?.sendChatMessage&&window.QCLI.ChatUI.sendChatMessage(e))}function ei(){let e=(X?.value||"").trim();if(!e){mn(!0);return}ti(e),mn(!0),E.finalText="",E.pendingText=""}function vc(){if(X&&(X.value=""),E.finalText="",E.pendingText="",E.active){try{E.recognition.stop()}catch(e){console.warn("[VoiceInput] rerecord stop failed:",e?.message)}setTimeout(()=>{try{E.recognition&&E.recognition.start()}catch{}},150)}else vn()}function mn(e){Z&&Z.classList.add("hidden"),e&&(E.pendingText="",X&&(X.value=""))}function bc(e){if(hc(),E.pendingText=e,E._targetPinned||(E.target=gn()),X){let t=X.value.trim();X.value=(t?t+(t.endsWith(`
`)?"":`
`):"")+e}Pe&&(Pe.textContent=$t(E.target)),Z.classList.remove("hidden"),X&&(X.focus(),X.setSelectionRange(X.value.length,X.value.length))}function yc(e){if(!e||!e.trim())return;let t=e.trim();Q.autoSend?ti(t):bc(t)}function si(){let e=window.SpeechRecognition||window.webkitSpeechRecognition;return e?(E.recognition=new e,E.recognition.continuous=!0,E.recognition.interimResults=!0,E.recognition.lang=Q.lang||"zh-CN",E.recognition.onresult=t=>{for(let s=t.resultIndex;s<t.results.length;s++){let n=t.results[s][0].transcript;t.results[s].isFinal&&(E.finalText+=n,yc(n))}},E.recognition.onerror=t=>{if(console.warn("[Voice] Error:",t.error),t.error==="no-speech"){if(E.active&&E.recognition)try{E.recognition.start()}catch(s){console.warn("[VoiceInput] Recognition start failed:",s?.message)}return}t.error!=="aborted"&&(Rt(),window.QCLI?.showToast?.(`Voice error: ${t.error}`,"error"))},E.recognition.onend=()=>{if(E.active&&E.recognition)try{E.recognition.start()}catch{Rt()}},!0):(ae&&(ae.title="Speech recognition not supported in this browser",ae.style.opacity="0.3",ae.style.cursor="not-allowed"),!1)}function ni(){if(!E.recognition&&!si()){window.QCLI?.showToast?.("Speech recognition not available in this browser. Try Chrome or Edge.","error");return}E.recognition&&(E.recognition.lang=Q.lang||"zh-CN"),E.active?Rt():vn()}function vn(){if(E.recognition)try{if(E.active=!0,E.finalText="",E.recognition.start(),ae&&ae.classList.add("recording"),Qe){Qe.classList.remove("hidden");let e=Qe.querySelector(".voice-text");e&&(e.textContent="Listening...")}window.QCLI?.showToast?.("Voice input active \u2192 speak, then confirm to send","info")}catch{E.active=!1,window.QCLI?.showToast?.("Could not start microphone. Check permissions.","error"),ae&&ae.classList.remove("recording"),Qe&&Qe.classList.add("hidden")}}function Rt(){try{E.recognition&&E.recognition.stop()}catch(e){console.warn("[VoiceInput] Error:",e?.message)}E.active=!1,E.finalText="",ae&&ae.classList.remove("recording"),Qe&&Qe.classList.add("hidden")}function ai(e){Q.autoSend=!!e,hn("autoSend",Q.autoSend)}function ii(e){e&&(Q.lang=e,hn("lang",e),E.recognition&&(E.recognition.lang=e))}function oi(e){if(!["auto","chat","terminal"].includes(e)||e===Q.defaultTarget)return;Q.defaultTarget=e,hn("defaultTarget",e),E._targetPinned=!1,E.target=gn(),Pe&&(Pe.textContent=$t(E.target)),ci();let t={auto:"\u81EA\u52A8\uFF08\u6309\u7126\u70B9/\u7EC8\u7AEF\uFF09",chat:"\u804A\u5929\uFF08AI \u52A9\u624B\uFF09",terminal:"\u7EC8\u7AEF"};window.QCLI?.showToast?.(`\u9ED8\u8BA4\u53D1\u9001\u76EE\u6807 \u2192 ${t[e]}\uFF08\u8BC6\u522B\u540E${$t(E.target)}\uFF09`,"info",2e3)}function xc(){return{...Q}}function wc(){if(document.getElementById("voice-input-panel-style"))return;let e=document.createElement("style");e.id="voice-input-panel-style",e.textContent=`
...
`,document.head.appendChild(e)}function ri(){wc();let e=document.getElementById("vi-settings-panel");e||(e=Tc()),e.classList.contains("hidden")?(kc(e),e.classList.remove("hidden"),Cc(e)):e.classList.add("hidden")}function kc(e){let t=document.getElementById("voice-input-settings-btn");if(!t)return;let s=t.getBoundingClientRect(),n=340,a=360,o=8,i=16,r=s.right-n;r<i&&(r=i),r+n+i>window.innerWidth&&(r=Math.max(i,window.innerWidth-n-i)),e.style.right="auto";let c=s.bottom+o;c+a+i>window.innerHeight&&(c=s.top-a-o,c<i&&(c=i)),e.style.top=`${c}px`,e.style.left=`${r}px`,e.style.removeProperty("right")}function Tc(){let e=[["zh-CN","\u4E2D\u6587"],["en-US","English"],["ja-JP","\u65E5\u672C\u8A9E"],["ko-KR","\uD55C\uAD6D\uC5B4"]].map(([s,n])=>`<option value="${s}">${n}</option>`).join(""),t=document.createElement("div");return t.id="vi-settings-panel",t.className="vi-settings-panel hidden",t.innerHTML=`
  ...
  `,document.body.appendChild(t),t.querySelector("#vi-settings-close").addEventListener("click",()=>{t.classList.add("hidden")}),t}function Cc(e){let t=e.querySelector("#vi-autosend"),s=e.querySelector("#vi-lang"),n=e.querySelector("#vi-default-target");t&&(t.checked=!!Q.autoSend),s&&(s.value=Q.lang||"zh-CN"),n&&(n.value=Q.defaultTarget||"auto"),ci()}function ci(){let e=document.getElementById("vi-effective-target");if(!e)return;let t=Q.defaultTarget||"auto",s=gn(),n={auto:"\u81EA\u52A8\uFF08\u6309\u7126\u70B9/\u7EC8\u7AEF\uFF09",chat:"\u804A\u5929\uFF08AI \u52A9\u624B\uFF09",terminal:"\u7EC8\u7AEF"}[t],a=$t(s),o=t==="auto"?"":t!==s?' <span style="color:var(--text-tertiary);font-size:11px">\uFF08\u88AB\u624B\u52A8\u8986\u76D6\uFF09</span>':"";e.innerHTML=`
    <span>\u5F53\u524D\u9ED8\u8BA4\uFF1A<strong>${n}</strong></span>
    <span>\u5F53\u524D\u751F\u6548\uFF1A<strong>${a}</strong>${o}</span>
  `}function Ec(){document.addEventListener("change",e=>{let t=e.target;t.id==="vi-autosend"?ai(t.checked):t.id==="vi-lang"?ii(t.value):t.id==="vi-default-target"&&oi(t.value)}),document.addEventListener("click",e=>{if(e.target.closest("#voice-input-settings-btn")){e.preventDefault(),ri();return}let s=document.getElementById("vi-settings-panel");if(s&&!s.classList.contains("hidden")){let n=e.target===s||s.contains(e.target),a=e.target.closest("#voice-input-settings-btn");!n&&!a&&s.classList.add("hidden")}})}ae&&(ae.addEventListener("click",ni),si());Ec();window.addEventListener("beforeunload",()=>{E.active&&Rt()});var Lc={toggle:ni,start:vn,stop:Rt,setAutoSend:ai,setLang:ii,setDefaultTarget:oi,getInputSettings:xc,toggleSettingsPanel:ri};mc.VoiceInput=Lc;var Sc=window.QCLI=window.QCLI||{},w={currentUtterance:null,speaking:!1,paused:!1,queue:[],enabled:!1,autoRead:!0,rate:1,pitch:1,volume:1,selectedVoice:null,language:"auto",engine:"web",edgeVoice:null},pi="qcli-tts-",ui=["enabled","autoRead","rate","pitch","volume","selectedVoice","language","engine","edgeVoice"];function Ic(){for(let e of ui){let t=M.get(pi+e);t!==null&&(e==="enabled"||e==="autoRead"?w[e]=t==="true":e==="rate"||e==="pitch"||e==="volume"?w[e]=parseFloat(t):e==="edgeVoice"?w.edgeVoice=t==="null"||t===""?null:t:w[e]=t)}}function _c(){for(let e of ui)M.set(pi+e,String(w[e]))}function wn(){return window.speechSynthesis?.getVoices()||[]}function fi(){let e=wn();if(w.selectedVoice){let t=e.find(s=>s.voiceURI===w.selectedVoice);if(t)return t}return mi(e)}function mi(e,t){let s=t||bn(),n=e.find(o=>o.lang.startsWith(s));if(n)return n;let a=e.find(o=>o.lang.startsWith(s.slice(0,2)));return a||e[0]||null}function bn(){return w.language==="auto"?(document.documentElement.lang||navigator.language||"zh-CN").startsWith("zh")?"zh":"en":w.language}function yn(e){if(!e)return bn();let t=(e.match(/[\u4e00-\u9fff\u3400-\u4dbf]/g)||[]).length,s=e.length;return s===0?bn():t/s>.15?"zh":"en"}function Mc(e,t=150){if(!e||e.length<=t)return[e];let s=[],n="";for(let a=0;a<e.length;a++)if(n+=e[a],n.length>=t){let o=n.match(/^(.+?)([，。！？!?;；\s,])/);o&&o[1].length>=20?(s.push(o[1]+o[2]),n=n.slice(o[0].length)):(s.push(n),n="")}return n&&s.push(n),s}function li(){if(w.queue.length>0||w.speaking)return!0;let e=window.speechSynthesis;return!!(e&&e.speaking)}function hi(e){return e?e.replace(/[\u{1F000}-\u{1FAFF}\u{1F1E6}-\u{1F1FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{2B00}-\u{2BFF}\u{2300}-\u{23FF}\u{FE00}-\u{FE0F}]/gu,""):""}function He(e,t={}){if(!w.enabled||!e||!e.trim()||(e=hi(e),!e||!e.trim()))return!1;let s=e.replace(/[\x00-\x08\x0b\x0c\x0e-\x1f]/g,"").replace(/[。？！]/g,"\uFF0C").replace(/\n+/g,"\uFF0C").trim();if(!s)return!1;let n=Mc(s,150);if(n.length>1){let a=t.lang||yn(n[0]);if(li())return t.enqueue&&n.forEach(r=>w.queue.push({text:r,lang:a})),!!t.enqueue;let[o,...i]=n;return i.forEach(r=>w.queue.push({text:r,lang:a})),us(o,{...t,lang:a})}return li()?t.enqueue?(w.queue.push({text:s,lang:t.lang||yn(s)}),!0):!1:us(s,t)}function us(e,t){let s=window.speechSynthesis;if(!s)return!1;s.cancel(),w.speaking=!1;let n=t.lang||yn(e),a=new SpeechSynthesisUtterance(e);a.lang=n==="zh"?"zh-CN":"en-US",a.rate=w.rate,a.pitch=w.pitch,a.volume=w.volume;let o=fi();o&&(a.voice=o),a.onstart=()=>{w.speaking=!0,w.currentUtterance=a,ht(),t.onStart?.()},a.onend=()=>{if(w.speaking=!1,w.currentUtterance=null,ht(),t.onEnd?.(),w.queue.length>0){let i=w.queue.shift();us(i.text,{lang:i.lang})}},a.onerror=i=>{if(console.warn("[VoiceOutput] Speech error:",i.error),w.speaking=!1,w.currentUtterance=null,ht(),w.queue.length>0){let r=w.queue.shift();us(r.text,{lang:r.lang})}};try{return s.speak(a),w.speaking=!0,w.currentUtterance=a,!0}catch(i){return console.warn("[VoiceOutput] speak() failed:",i.message),!1}}function kn(){let e=window.speechSynthesis;e&&e.cancel(),w.speaking=!1,w.currentUtterance=null,w.queue=[],ht()}function Ac(){let e=window.speechSynthesis;e&&(e.paused?(e.resume(),w.paused=!1):w.speaking&&(e.pause(),w.paused=!0),ht())}function $c(e){if(!w.enabled||!w.autoRead)return;if(!e||e.length>3e3){e&&e.length>3e3&&w.enabled&&He("AI \u56DE\u590D\u5185\u5BB9\u8F83\u957F\uFF0C\u8BF7\u5728\u804A\u5929\u9762\u677F\u4E2D\u9605\u8BFB",{enqueue:!0});return}let t=fs(e);He(t,{enqueue:!0})}function fs(e){return e?e.replace(/```[\s\S]*?```/g,"\u4EE3\u7801\u5757").replace(/`([^`]+)`/g,"$1").replace(/!\[([^\]]*)\]\([^)]+\)/g,(t,s)=>s||"\u56FE\u7247").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/(\*{1,3}|_{1,3})(.+?)\1/g,"$2").replace(/^#{1,6}\s+/gm,"").replace(/^[\s]*[-*+]\s+/gm,"").replace(/^\s*\d+[.)]\s+/gm,"").replace(/^>\s+/gm,"").replace(/^[-*_]{3,}\s*$/gm,"").replace(/\|/g," ").replace(/[-:]+\s*[-:|]+\s*/g,"").replace(/<[^>]+>/g,"").replace(/\n{2,}/g," ").trim():""}function ht(){let e=document.getElementById("tts-toggle-btn"),t=document.getElementById("tts-indicator");e&&(e.classList.toggle("speaking",w.speaking),e.classList.toggle("tts-enabled",w.enabled),e.title=w.enabled?w.speaking?"\u{1F50A} \u6B63\u5728\u6717\u8BFB...":"\u{1F50A} \u8BED\u97F3\u8F93\u51FA\u5DF2\u5F00\u542F":"\u{1F507} \u8BED\u97F3\u8F93\u51FA\u5DF2\u5173\u95ED"),t&&t.classList.toggle("hidden",!w.speaking)}function Rc(){return{...w}}function Ce(e){let t=!1;for(let[s,n]of Object.entries(e))s in w&&w[s]!==n&&(w[s]=n,t=!0);t&&(_c(),ht(),e.enabled===!1&&kn())}function gi(e){Ce({enabled:!!e})}function vi(e){Ce({autoRead:!!e})}function Bc(e){Ce({rate:Math.max(.1,Math.min(10,parseFloat(e)||1))})}function Pc(e){Ce({pitch:Math.max(0,Math.min(2,parseFloat(e)||1))})}function Hc(e){Ce({volume:Math.max(0,Math.min(1,parseFloat(e)||1))})}function Nc(e){["auto","zh","en"].includes(e)&&Ce({language:e})}function bi(e){["web","edge","auto"].includes(e)&&Ce({engine:e})}function Tn(e){Ce({edgeVoice:e||null})}function zc(e){if(!w.enabled||!w.autoRead)return!1;let t=fs(e||"");return!t||t.length>3e3?(t&&t.length>3e3&&w.enabled&&He("AI \u56DE\u590D\u5185\u5BB9\u8F83\u957F\uFF0C\u8BF7\u5728\u804A\u5929\u9762\u677F\u4E2D\u9605\u8BFB",{enqueue:!0}),!1):w.engine==="edge"&&typeof Bt=="function"?Bt(t,{enqueue:!0}):He(t,{enqueue:!0})}var ps=null,di=Promise.resolve();async function Bt(e,t={}){if(!w.enabled||!e||!e.trim()||(e=hi(e),e=e.replace(/[。？！]/g,"\uFF0C").replace(/\n+/g,"\uFF0C"),!e||!e.trim()))return!1;if(!(w.engine==="edge"||w.engine==="auto"&&ps!==!1))return ps=!1,He(e,t);let n=w.edgeVoice||"zh-CN-XiaoxiaoNeural",a=String(w.rate||"1.0"),o=fetch("/api/tts/synthesize",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:e,voice:n,rate:a})}).then(async c=>{if(!c.ok)throw new Error("status "+c.status);return c.arrayBuffer()}),i=di,r;di=new Promise(c=>{r=c}),await i;try{let c=await o;if(!await qc(c))throw new Error("decode failed");return ps=!0,!0}catch(c){return console.warn("[VoiceOutput] Edge TTS failed, fallback to Web Speech:",c&&c.message),ps=!1,await Oc(e,t),!0}finally{r()}}function Oc(e,t={}){return new Promise(s=>{let n=!1,a=()=>{n||(n=!0,s(!0))};He(e,{...t,onEnd:a})||a(),setTimeout(a,8e3)})}function qc(e){return new Promise(t=>{let s=window.AudioContext||window.webkitAudioContext;if(!s){t(!1);return}let n=new s;n.decodeAudioData(e.slice(0),a=>{let o=n.createBufferSource();o.buffer=a,o.connect(n.destination),o.onended=()=>{n.close(),t(!0)},o.start(0)},a=>{console.warn("[VoiceOutput] decodeAudioData failed:",a),n.close(),t(!1)})})}function jc(e){Ce({selectedVoice:e||null})}function xn(){let e=document.getElementById("tts-settings-panel");e||(e=Dc()),e.classList.toggle("hidden"),e.classList.contains("hidden")||Cn(e)}function Dc(){if(!document.getElementById("tts-input-style")){let t=document.createElement("style");t.id="tts-input-style",t.textContent=".tts-setting-section-title{padding:6px 0 2px;font-size:12px;font-weight:600;color:var(--text-secondary,#aaa);letter-spacing:.04em}.tts-voice-group[hidden]{display:none}",document.head.appendChild(t)}let e=document.createElement("div");return e.id="tts-settings-panel",e.className="tts-settings-panel hidden",e.innerHTML=`
  ...
  `,document.body.appendChild(e),e.querySelector("#tts-settings-close").addEventListener("click",()=>{e.classList.add("hidden")}),e.addEventListener("click",t=>{t.target===e&&e.classList.add("hidden")}),e}function Cn(e){Vc();let t=e.querySelector("#tts-voice");if(t){let a=wn(),o=w.selectedVoice;if(t.innerHTML=a.map(i=>`<option value="${i.voiceURI}" ${i.voiceURI===o?"selected":""}>
        ${i.name} (${i.lang})
      </option>`).join(""),!o&&t.options.length>0){let i=mi(a);i&&(t.value=i.voiceURI)}}let s=e.querySelector("#tts-edge-voice"),n=e.querySelector('.tts-voice-group[data-engine="edge"]');s&&n&&!n.hidden&&Fc(s)}async function Fc(e){try{let t=await fetch("/api/tts/voices");if(!t.ok)throw new Error("status "+t.status);let s=await t.json(),n=(s.voices||[]).filter(o=>o.locale&&o.locale.startsWith("zh")),a=n.length?n:s.voices||[];e.innerHTML=a.map(o=>`<option value="${o.name}" ${o.name===w.edgeVoice?"selected":""}>${o.name} (${o.locale})</option>`).join(""),!w.edgeVoice&&e.options.length>0?(e.value=e.options[0].value,Tn(e.options[0].value)):w.edgeVoice&&!a.some(o=>o.name===w.edgeVoice)&&console.warn("[VoiceOutput] saved Edge voice not in list:",w.edgeVoice)}catch(t){console.warn("[VoiceOutput] load Edge voices failed:",t&&t.message);let s=w.edgeVoice&&w.edgeVoice!=="null"?w.edgeVoice:"zh-CN-XiaoxiaoNeural";e.innerHTML=`<option value="${s}">${s}\uFF08\u52A0\u8F7D\u5931\u8D25\uFF0C\u7A0D\u540E\u91CD\u8BD5\uFF09</option>`,e.value=s}}function Uc(){document.addEventListener("change",e=>{let t=e.target;switch(t.id){case"tts-enabled":gi(t.checked);break;case"tts-auto-read":vi(t.checked);break;case"tts-rate":{Bc(t.value);let s=document.getElementById("tts-rate-val");s&&(s.textContent=parseFloat(t.value).toFixed(1)+"x");break}case"tts-pitch":{Pc(t.value);let s=document.getElementById("tts-pitch-val");s&&(s.textContent=parseFloat(t.value).toFixed(1));break}case"tts-volume":{Hc(t.value);let s=document.getElementById("tts-volume-val");s&&(s.textContent=Math.round(parseFloat(t.value)*100)+"%");break}case"tts-language":Nc(t.value);break;case"tts-voice":jc(t.value);break;case"tts-engine":{bi(t.value);let s=document.getElementById("tts-settings-panel");s&&Cn(s);break}case"tts-edge-voice":Tn(t.value);break}}),document.addEventListener("input",e=>{e.target.id}),document.addEventListener("click",e=>{e.target.id==="tts-test-btn"&&Qc("\u4F60\u597D\uFF0C\u6B22\u8FCE\u4F7F\u7528\u8BED\u97F3\u8F93\u51FA\u529F\u80FD\u3002\u8FD9\u662F\u4E00\u6761\u6D4B\u8BD5\u8BED\u97F3\u3002")})}function Qc(e){if(!w.enabled)return!1;let t=fs(e||"");if(!t)return!1;let s=w.engine||"web";return s==="edge"||s==="auto"?Bt(t):He(t)}function Vc(){let e=w.engine||"web",t=e==="web"||e==="auto",s=e==="edge"||e==="auto";document.querySelectorAll(".tts-voice-group").forEach(n=>{let a=n.dataset.engine;n.hidden=a==="web"?!t:!s})}var Wc={get state(){return{...w}},get enabled(){return w.enabled},get speaking(){return w.speaking},speak:He,speakAIResponse:$c,speakSentence:zc,speakStreaming:Bt,stop:kn,togglePause:Ac,getVoices:wn,getSelectedVoice:fi,getSettings:Rc,updateSettings:Ce,setEnabled:gi,setAutoRead:vi,setEngine:bi,setEdgeVoice:Tn,toggleSettingsPanel:xn,stripMarkdown:fs};Sc.VoiceOutput=Wc;Ic();Uc();window.speechSynthesis&&window.speechSynthesis.getVoices().length===0&&(window.speechSynthesis.onvoiceschanged=()=>{let e=document.getElementById("tts-settings-panel");e&&!e.classList.contains("hidden")&&Cn(e)});document.addEventListener("click",e=>{(e.target.id==="tts-toggle-btn"||e.target.closest("#tts-toggle-btn"))&&(e.preventDefault(),w.enabled&&w.speaking?kn():xn())});console.log("[VoiceOutput] Initialized (enabled:",w.enabled,")");var Ne=window.QCLI=window.QCLI||{},L={list:[],active:null,ws:null};async function xi(){try{let e=await fetch("/api/workflows");if(!e.ok)return[];let t=await e.json();return L.list=t.workflows||[],Ve(),L.list}catch(e){return console.warn("[Workflows] Load failed:",e),[]}}var wi=null;function Ve(){let e=wi||document.getElementById("workflow-list");if(!e)return;if(e.innerHTML="",L.list.length===0){e.innerHTML='<div class="agent-empty">No workflows available</div>';return}let t=document.createElement("div");t.className="wfp-header",t.innerHTML=`
      <span class="wfp-header-icon">\u26A1</span>
      <span class="wfp-header-title">\u5DE5\u4F5C\u6D41</span>
      <span class="wfp-header-count">${L.list.length}</span>
    `,e.appendChild(t);let s=document.createElement("div");s.className="wfp-list",e.appendChild(s);for(let n of L.list){let a=document.createElement("div");a.className="wfp-item",a.dataset.wfId=n.id;let o=(n.name||"").replace(/^[\p{Emoji_Presentation}\p{Extended_Pictographic}]\s*/u,"").trim()||n.name;a.title=n.description||o;let i=document.createElement("div");i.className="wfp-left",i.innerHTML=`<span class="wfp-icon">${n.icon||"\u26A1"}</span><span class="wfp-name">${o}</span>`,a.appendChild(i);let r=document.createElement("div");r.className="wfp-badges";let c=document.createElement("span");c.className="wfp-badge steps",n.tasks&&Array.isArray(n.tasks)&&n.tasks.length>0?(c.textContent="DAG",c.classList.add("dag"),a.dataset.dag="1"):c.textContent=`${n.steps.length} \u6B65`,r.appendChild(c);let l=document.createElement("span");l.className="wfp-badge cat",n.tasks&&Array.isArray(n.tasks)&&n.tasks.length>0?(l.textContent="\u5E76\u884C",l.classList.add("parallel")):(l.textContent="\u987A\u5E8F",l.classList.add("sequential")),r.appendChild(l),a.appendChild(r),L.active&&L.active.id===n.id&&L.active.status==="running"&&a.classList.add("running"),a.addEventListener("click",()=>{Gc(n)}),s.appendChild(a)}}function Gc(e){if(e.tasks&&Array.isArray(e.tasks)&&e.tasks.length>0){Ne.Orchestrator?.runDAG?(Ne.Orchestrator.runDAG(e),Ne.RightPanel?.switchTab&&Ne.RightPanel.switchTab("orchestrator")):Ee("\u7F16\u6392\u6A21\u5757\u672A\u5C31\u7EEA","error");return}let t=e.variables;if(t&&Object.keys(t).length>0){Jc(e);return}ms(e)}function Jc(e){let t=e.variables||{},s=Object.keys(t);if(s.length===0){ms(e);return}let n="";for(let c of s){let l=t[c],d=l.label||c,p=l.required?"required":"",u=l.default||"";if(n+=`<label>${d}`,l.type==="select"&&l.options){n+=`<select id="wf-var-${c}" class="wf-var-input" ${p}>`;for(let f of l.options)n+=`<option value="${f}"${f===u?" selected":""}>${f}</option>`;n+="</select>"}else if(l.type==="number"){let f=l.min!=null?` min="${l.min}"`:"",m=l.max!=null?` max="${l.max}"`:"";n+=`<input type="number" id="wf-var-${c}" class="wf-var-input" value="${u}" ${p}${f}${m}>`}else n+=`<input type="text" id="wf-var-${c}" class="wf-var-input" value="${u}" placeholder="${l.placeholder||""}" ${p}>`;l.description&&(n+=`<small>${l.description}</small>`),n+="</label>"}let a=document.createElement("div");a.className="modal-overlay hidden",a.id="wf-variable-modal",a.innerHTML=`
