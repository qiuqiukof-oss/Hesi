var m={host:"\u{1F00F}",fox:"\u{1F004}",panda:"\u{1F005}",owl:"\u{1F006}",bunny:"\u{1F007}"};function i(e,o){if(!e)return`rgba(0,0,0,${o})`;let n=String(e).replace("#",""),t=n.length===3?n.split("").map(s=>s+s).join(""):n,r=parseInt(t.slice(0,2),16)||0,c=parseInt(t.slice(2,4),16)||0,h=parseInt(t.slice(4,6),16)||0;return`rgba(${r},${c},${h},${o})`}var d=typeof window<"u"?window:{},a=d.__hesiSkins=d.__hesiSkins||{hearth:{id:"hearth",label:"\u{1F525} \u56F4\u7089",activeGlow:e=>`0 0 18px ${i(e,.55)}`,messageIcon:()=>"\u{1F525}",tileAnim:!1,css:`
...
`},mahjong:{id:"mahjong",label:"\u{1F004} \u9EBB\u5C06\u95F2\u8C08",activeGlow:e=>`0 0 18px ${i(e,.55)}`,messageIcon:e=>m[e]||"\u{1F004}",tileAnim:!0,css:`
