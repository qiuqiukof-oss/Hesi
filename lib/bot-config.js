...
// 配置文件路径：默认 data/bots-config.json；HESI_BOT_CONFIG 可覆盖
// （测试隔离用：测试走临时文件，不碰真实用户凭证，避免残留污染）
function getConfigFile() {
  return process.env.HESI_BOT_CONFIG || path.join(__dirname, '..', 'data', 'bots-config.json');
}
