<p align="center">
  <strong>Hesi（合思）个人版 v1.1.5-fix — 浏览器里的终端 + AI 智能体中枢</strong><br>
...
| 💻 **零安装试用**（推荐新手） | 下载 [v1.1.5-fix 桌面托盘版](https://github.com/qiuqiukof-oss/Hesi/releases/tag/v1.1.5-fix)，解压后双击 `tray.bat`（Windows）/ `./tray.sh`（macOS/Linux），浏览器自动打开 `http://127.0.0.1:4264` |
...
- **主题定制器** — 内置 6 套预设（宣纸 / 素 / 玄夜 / 深空 / 明 / 暗）+ 自定义保存，**全站（含独立页面与插件页）跟随主题**
